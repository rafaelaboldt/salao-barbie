  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#benefits" className="text-sm font-medium text-barbie-gray-600 hover:text-barbie-pink transition-colors">
              Benefícios
            </a>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6 text-barbie-dark">
              Gerencie seu{" "}
              <span className="inline-block rounded-2xl bg-barbie-gradient px-3 py-1 text-white shadow-lg">
                salão
              </span>{" "}
              com{" "}
              <span className="inline-block rounded-2xl bg-barbie-gradient px-3 py-1 text-white shadow-lg">
      ...
      {/* ============================================
          BENEFITS SECTION
          ============================================ */}
      <section id="benefits" className="py-20 px-6 bg-white/70">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-barbie-dark mb-4">
              Por que escolher o Salão Barbie?
            </h2>
            <p className="text-barbie-gray-500 max-w-2xl mx-auto">
              Mais organização, menos retrabalho e uma experiência mais bonita para sua equipe e seus clientes.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Automatize agendamentos, confirmações e organização do dia sem perder o controle.",
              },
              {
                title: "Atendimento premium",
                desc: "Tenha um histórico completo dos clientes para oferecer um atendimento mais personalizado.",
              },
              {
                title: "Crescimento inteligente",
                desc: "Acompanhe faturamento, estoque e produtividade com relatórios claros e práticos.",
              },
            ].map((benefit) => (
              <div key={benefit.title} className="card p-8 text-center">
                <div className="w-12 h-12 rounded-2xl bg-barbie-gradient mx-auto mb-4 flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-lg font-bold text-barbie-dark mb-2">{benefit.title}</h3>
                <p className="text-sm text-barbie-gray-500 leading-relaxed">{benefit.desc}</p>
              </div>
            ))}
          </div>
        </div>
